  ...
  return (
    <div className="explore-card pointer">
      <div className="explore-card-cover">
        ...
        {goldOff && <div className="gold-off center">{goldOff}</div>}
        {discount && <div className="discount center">{discount}</div>}
      </div>
      <div className="res-row">
        <div className="res-name ">{name}</div>
        {rating && (
          <div className="res-rating center">
            {rating}
            <i className="fi fi-rr-star center"></i>
          </div>
        )}
      </div>
      <div className="res-row">
